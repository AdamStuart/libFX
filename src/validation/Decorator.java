...
public class Decorator<T extends Node> {
     ...
     */
    public ReadOnlyObjectProperty<T> nodeProperty() {        return nodePropertyImpl().getReadOnlyProperty();    }

    protected ReadOnlyObjectWrapper<T> nodePropertyImpl() {
        if (_nodeProperty == null)             _nodeProperty = new ReadOnlyObjectWrapper<>();
     ...
     */
    public T getNode() {        return nodePropertyImpl().get();    }

    public ReadOnlyObjectProperty<Pos> posProperty() {        return posPropertyImpl().getReadOnlyProperty();    }
     ...
     */
    public Pos getPos() {        return posProperty().get();    }


    public ReadOnlyObjectProperty<Point2D> offsetProperty() {        return offsetPropertyImpl().getReadOnlyProperty();    }
     ...
     */
    public Point2D getPosOffset() {        return offsetProperty().get();    }

    public ReadOnlyObjectProperty<Insets> paddingProperty() {        return paddingPropertyImpl().getReadOnlyProperty();    }

    protected ReadOnlyObjectWrapper<Insets> paddingPropertyImpl() {
        if (_paddingProperty == null)             _paddingProperty = new ReadOnlyObjectWrapper<>();
     ...
     */
    public Insets getPadding() {        return paddingProperty().get();    }
    ...
    public ReadOnlyBooleanProperty valueInPercentProperty() {        return valueInPercentPropertyImpl().getReadOnlyProperty();    }
     ...
     */
    public boolean isValueInPercent() {        return valueInPercentProperty().get();    }
     ...
     */
    public Transition getTransition() {        return transitionProperty().get();    }
