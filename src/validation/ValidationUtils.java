...
//        if (observableValue == null || validator == null || eventFilter == null)        return false;
//
//        switch (mode) {
...
//            ValidationObject validationObject = new ValidationObject(targetNode, old, newval);
...
//
//    	System.out.println("forceValidate");
////        switch (mode) {
////            case ON_FLY:
...
////                break;
////            case ON_FOCUS_LOST:
////                validator = props.get(PROPERTY_ON_FOCUS_LOST_VALIDATOR);
...
//            double x = point.getX() + sc.getX() + win.getX();
//            double y = point.getY() + sc.getY() + win.getY();
//            label.getTooltip().setAutoHide(true);
//            label.getTooltip().show(win, x,y);
//        }
//    }
//
//    /**
