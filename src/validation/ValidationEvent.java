/*
 * @(#)ValidationEvent.java 5/19/2013
 *
...
public class ValidationEvent extends Event {
     ...
     */
    public static final EventType<ValidationEvent> ANY =   new EventType<>(Event.ANY, "VALIDATION"); //NON-NLS

    /**
     * This event occurs on the validation is ok
     */
    public static final EventType<ValidationEvent> VALIDATION_OK =  new EventType<>(ValidationEvent.ANY, "VALIDATION_OK"); //NON-NLS

    /**
     * This event occurs on the validation has information
     */
    public static final EventType<ValidationEvent> VALIDATION_INFO =  new EventType<>(ValidationEvent.ANY, "VALIDATION_INFO"); //NON-NLS

    /**
     * This event occurs on the validation has warning
     */
    public static final EventType<ValidationEvent> VALIDATION_WARNING =  new EventType<>(ValidationEvent.ANY, "VALIDATION_WARNING"); //NON-NLS

    /**
     * This event occurs on the validation has error
     */
    public static final EventType<ValidationEvent> VALIDATION_ERROR = new EventType<>(ValidationEvent.ANY, "VALIDATION_ERROR"); //NON-NLS

    /**
     * This event occurs on the validation status is unknown. This event can be used to clear the previous validation
     * status.
     */
    public static final EventType<ValidationEvent> VALIDATION_UNKNOWN =  new EventType<>(ValidationEvent.ANY, "VALIDATION_UNKNOWN"); //NON-NLS
     ...
     */
    public ValidationEvent() {        this(VALIDATION_UNKNOWN);    }
     ...
     */
    public ValidationEvent(EventType<ValidationEvent> type) {        this(type, 0);    }
     ...
     */
    public ValidationEvent(EventType<ValidationEvent> type, int id) {        this(type, id, "");    }
     ...
     */
    public Object getProposedValue() {        return _proposedValue;    }
     ...
     */
    public FailBehavior getFailBehavior() {        return _failBehavior;    }
