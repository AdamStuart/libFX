...
final public class SystemInfo {
    ...
    static {
        ...
        String os = getProperty("os.name", "Windows XP"); //NON-NLS

        // set the operating system variables
        _isWindows = os.contains("Windows"); //NON-NLS
        try {
            String osVersion = getProperty("os.version", "5.0"); //NON-NLS
        ...
        if (os.contains("Windows XP") || os.contains("Windows NT") || os.contains("Windows 2000")) { //NON-NLS
            _isWindowsNTor2000 = true;
        }
        if (os.contains("Windows XP")) { //NON-NLS
            _isWindowsXP = true;
        }
        if (os.contains("Windows Vista")) { //NON-NLS
            _isWindowsVista = true;
        }
        if (os.contains("Windows 7")) { //NON-NLS
            _isWindows7 = true;
        }
        if (os.contains("Windows 8")) { //NON-NLS
            _isWindows8 = true;
        }
        if (os.contains("Windows 2003")) { //NON-NLS
            _isWindows2003 = true;
            _isWindowsXP = true;
        }
        if (os.contains("Windows 95")) { //NON-NLS
            _isWindows95 = true;
        }
        if (os.contains("Windows 98")) { //NON-NLS
            _isWindows98 = true;
        }
        if (_isWindows) _supportsTray = true;
        _isSolaris = (os.contains("Solaris")) || (os.contains("SunOS")); //NON-NLS
        _isLinux = os.contains("Linux"); //NON-NLS
        if (os.startsWith("Mac OS")) { //NON-NLS
            if (os.endsWith("X")) { //NON-NLS
                _isMacOSX = true;
            }
            else {
                _isMacClassic = true;
    ...
    public static String getJavaVersion() {
        return getProperty("java.version", "1.4.2"); //NON-NLS
    }
    ...
    public static String getJavaVendor() {
        return getProperty("java.vendor", ""); //NON-NLS
    }
    ...
    public static String getJavaClassVersion() {
        return getProperty("java.class.version", ""); //NON-NLS
    }
    ...
    public static String getOS() {
        return getProperty("os.name", "Windows XP"); //NON-NLS
    }
    ...
    public static String getOSVersion() {
        return getProperty("os.version", ""); //NON-NLS
    }
    ...
    public static String getOSArchitecture() {
        return getProperty("os.arch", ""); //NON-NLS
    }
    ...
    public static String getCurrentDirectory() {
        return getProperty("user.dir", ""); //NON-NLS
    }
    ...
    public static class JavaVersion {
        ...
        public JavaVersion(String version) {
            ...
            try {
                ...
                try {
                    ...
                    System.err.println("Please check the installation of your JDK. The version number " + version + " is not right."); //NON-NLS
                }
            }
        }
        ...
        public double getMajorVersion() {            return _majorVersion;        }
        public int getMinorVersion() {          return _minorVersion;       }
        public int getBuildNumber() {            return _buildNumber;        }
        public String getPatch() {            return _patch;        }
    }
