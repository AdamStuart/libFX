...
public class FXUtils {
    ...
    public static Insets add(Insets insets1, Insets insets2) {
        if (insets1 == null)      return insets2;
       if (insets2 == null)       return insets1;
    ...
    public static Node findAncestor(Node node, Class classToFind, Class classToStop) {
        ...
        while (node != null) {
            ...
            if (classToFind.isAssignableFrom(node.getClass()))          return node;
            node = node.getParent();
        }
        return null;
    }
    ...
    public interface Handler<T> {
         ...
         */
        default boolean condition(T c) {           return true;        }
    ...
    public interface ConditionHandler<T> extends Handler<T> {
         ...
         * @return true or false.
         */
        default boolean stopCondition(T c) {            return false;       }
    }
    ...
    public interface GetHandler<T> {
         ...
         */
        default Object action(T c) {          return c;      }
    }
