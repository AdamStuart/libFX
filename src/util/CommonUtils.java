...
public class CommonUtils {
     ...
     */
    public static boolean equals(Object o1, Object o2) {   return equals(o1, o2, false);    }
...
//        e.printStackTrace();
     ...
     * @param e the exception
     */
    public static void printException(Exception e) {        System.err.println(e.getLocalizedMessage());    }
    ...
    public static int binarySearch(List<Object> a, Object key) {
        ...
        while (x1 < x2) 
        {
            if (!(a.get(i) instanceof Comparable))                 return i;
    ...
    public static int binarySearch(Object[] a, Object key) {
        ...
        int i = x2 / 2, c;
        while (x1 < x2) {
            if (!(a[i] instanceof Comparable))             return i;
     ...
     *         point that would be used if the key were added to the array.
     */
    public static int binarySearch(int[] a, int key) {     return binarySearch(a, key, 0, a.length);   }
    ...
    public static <T, U> Comparator<T> comparing(Comparator<? super U> comparator, Function<? super T, ? extends U> keyExtractor) {
        ...
        return new Comparator<T>() {   @Override  public int compare(T c1, T c2) {
