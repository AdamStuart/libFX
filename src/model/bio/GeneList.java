...
//	public void setHeaderLine1(String string)	{	header1 = string;		}
//	public void setHeaderLine2(String string)	{	header2 = string;		}
//
//	Map<String, List<Double>> dimensions = new HashMap<String, List<Double>>();
